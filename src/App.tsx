        ...
        <div className='container cont card bg-dark card mt-5 '>
          <div className="row justify-content-center">
            ...
            <section className='cont1 bg-white col col-lg-7 p-5'>
              ...
              <div>
                <p>Passionate and motivated individual with knowledge in both backend and frontend development, seeking opportunities in the tech industry where I can learn and grow from within the company. Familiar with languages such as HTML, CSS, and JavaScript, and working with databases. Passionate about fostering innovation in an inclusive and welcoming environment, and eager to make positive contributions to projects while thriving within a collaborative team!</p>
              </div>
              <div>
